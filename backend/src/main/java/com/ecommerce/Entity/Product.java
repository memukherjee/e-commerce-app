...
public Product(String product_id, String product_name, Category product_category, String product_description,
		Colour product_colour, String product_company, double product_price, double product_discount,
		double discountPrice, int product_quantity, int product_sold, String product_imageUrl) {
	super();
...
public Colour getProduct_colour() {
	return product_colour;
}

public void setProduct_colour(Colour product_colour) {
	this.product_colour = product_colour;
}
