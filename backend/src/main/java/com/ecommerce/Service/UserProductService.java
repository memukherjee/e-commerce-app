...
public class UserProductService {
    ...
    public List<Product> filterProducts(double max, double min) {
        return repository.filterProducts(max, min);
    }

    public List<Product> filterProducts(double parseDouble, double parseDouble2, String category) {
        return repository.filterProducts(parseDouble, parseDouble2, category);
    }
